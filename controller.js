...
//functions for main Ship Calc
    ...
    function updateAllOutputStats() {
        ...
        //engines
        spanEngineMaxSpeed.textContent = "work in progress";
...
//init code
    ...
    //Main Ship Calculator
        ...
        //insert allocation values into calc
        ship.shieldPP = validateAsNumericInput(shieldAllocationTextBox.value)
        ship.enginePP = validateAsNumericInput(engineAllocationTextBox.value)
