...
//event listeners
    //Block Calculator
        ...
        function blockDropEvent(runCalc=true) {
            ...
            runCalc = runCalc && updateStatOtherLabel(blockList, validateDropDown(validMaterials, materialDropBox.value), validateDropDown(validBlocks, blockDropBox.value),statDropBox);
